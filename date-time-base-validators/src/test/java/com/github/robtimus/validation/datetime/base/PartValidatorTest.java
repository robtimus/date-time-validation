...
public class PartValidatorTest extends AbstractValidatorTest {
    ...
    public static final class OffsetDateTimeValidator extends PartValidator<TestConstraint, OffsetDateTime, Month> {

        public OffsetDateTimeValidator() {
            super(TestConstraint::zoneId, OffsetDateTime::getMonth, OffsetDateTime::atZoneSameInstant, ZonedDateTime::getMonth,
                    annotation -> (m, p) -> m == Month.DECEMBER);
        }
    }

    public static final class LocalDateValidator extends PartValidator.WithoutZoneId<TestConstraint, LocalDate, Month> {

        public LocalDateValidator() {
            super(TestConstraint::zoneId, LocalDate::getMonth, annotation -> (m, p) -> m == Month.DECEMBER);
        }
    }

    public static final class InstantValidator extends PartValidator.ForInstant<TestConstraint, Month> {

        public InstantValidator() {
            super(TestConstraint::zoneId, ZonedDateTime::getMonth, annotation -> (m, p) -> m == Month.DECEMBER);
        }
    }

    public static final class ZonedDateTimeValidator extends PartValidator.ForZonedDateTime<TestConstraint, Month> {
