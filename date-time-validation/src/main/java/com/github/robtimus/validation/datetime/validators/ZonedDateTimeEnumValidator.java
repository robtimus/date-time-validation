/*
 * ZonedDateTimeEnumValidator.java
...
/**
 * The base for all {@link ZonedDateTime} validators that validate only an enumerated part like the month.
 *
 * @author Rob Spoor
 * @param <A> The constraint annotation type.
 * @param <E> The enumerated part type.
 */
public abstract class ZonedDateTimeEnumValidator<A extends Annotation, E extends Enum<E>> extends TemporalAccessorEnumValidator<A, ZonedDateTime, E> {
     ...
     */
    protected ZonedDateTimeEnumValidator(Function<A, Set<E>> allowedValuesExtractor,
            Function<A, String> zoneIdExtractor,
            Function<ZonedDateTime, E> partExtractor) {

        super(allowedValuesExtractor, zoneIdExtractor, partExtractor, ZonedDateTime::withZoneSameInstant, partExtractor);
    }
}
