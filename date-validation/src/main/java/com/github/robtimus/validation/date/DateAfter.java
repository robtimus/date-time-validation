...
import com.github.robtimus.validation.date.DateAfter.List;
import com.github.robtimus.validation.date.validators.DateAfterValidator;
...
public @interface DateAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.date.DateAfter.message}";
