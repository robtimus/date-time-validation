...
import com.github.robtimus.validation.date.DateBefore.List;
import com.github.robtimus.validation.date.validators.DateBeforeValidator;
...
public @interface DateBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.date.DateBefore.message}";
