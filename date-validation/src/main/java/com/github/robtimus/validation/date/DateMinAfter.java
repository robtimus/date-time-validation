...
import com.github.robtimus.validation.date.DateMinAfter.List;
import com.github.robtimus.validation.date.validators.DateMinAfterValidator;
...
public @interface DateMinAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.date.DateMinAfter.message}";
