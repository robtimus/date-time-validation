...
import com.github.robtimus.validation.date.DateMinBefore.List;
import com.github.robtimus.validation.date.validators.DateMinBeforeValidator;
...
public @interface DateMinBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.date.DateMinBefore.message}";
