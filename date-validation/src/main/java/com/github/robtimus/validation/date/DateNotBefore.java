...
@DateMinAfter(moment = "", duration = "P0D")
...
public @interface DateNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.date.DateNotBefore.message}";
     ...
     */
    @OverridesAttribute(constraint = DateMinAfter.class)
    String moment();
