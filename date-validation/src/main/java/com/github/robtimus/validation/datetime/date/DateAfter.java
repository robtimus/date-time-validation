...
import com.github.robtimus.validation.datetime.date.DateAfter.List;
import com.github.robtimus.validation.datetime.date.validators.DateAfterValidator;
...
public @interface DateAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateAfter.message}";
