...
import com.github.robtimus.validation.datetime.date.DateBefore.List;
import com.github.robtimus.validation.datetime.date.validators.DateBeforeValidator;
...
public @interface DateBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateBefore.message}";
