...
import com.github.robtimus.validation.datetime.date.DateMaxAfter.List;
import com.github.robtimus.validation.datetime.date.validators.DateMaxAfterValidator;
...
public @interface DateMaxAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateMaxAfter.message}";
