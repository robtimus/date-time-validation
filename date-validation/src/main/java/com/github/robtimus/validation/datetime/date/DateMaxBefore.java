...
import com.github.robtimus.validation.datetime.date.DateMaxBefore.List;
import com.github.robtimus.validation.datetime.date.validators.DateMaxBeforeValidator;
...
public @interface DateMaxBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateMaxBefore.message}";
