...
import com.github.robtimus.validation.datetime.date.DateMinAfter.List;
import com.github.robtimus.validation.datetime.date.validators.DateMinAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { DateMinAfterValidator.ForDate.class,
        DateMinAfterValidator.ForCalendar.class,
        DateMinAfterValidator.ForInstant.class,
        DateMinAfterValidator.ForLocalDateTime.class,
        DateMinAfterValidator.ForOffsetDateTime.class,
        DateMinAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface DateMinAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateMinAfter.message}";
    ...
    /**
     * Defines several {@link DateMinAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link DateMinAfter} annotations.
         */
        DateMinAfter[] value();
    }
}
