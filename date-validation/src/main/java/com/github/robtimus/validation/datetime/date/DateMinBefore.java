...
import com.github.robtimus.validation.datetime.date.DateMinBefore.List;
import com.github.robtimus.validation.datetime.date.validators.DateMinBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { DateMinBeforeValidator.ForDate.class,
        DateMinBeforeValidator.ForCalendar.class,
        DateMinBeforeValidator.ForInstant.class,
        DateMinBeforeValidator.ForLocalDateTime.class,
        DateMinBeforeValidator.ForOffsetDateTime.class,
        DateMinBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface DateMinBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateMinBefore.message}";
    ...
    /**
     * The minimum amount of time, as an <a href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 duration</a>, that the date part of
    ...
    /**
     * Defines several {@link DateMinBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link DateMinBefore} annotations.
         */
        DateMinBefore[] value();
    }
}
