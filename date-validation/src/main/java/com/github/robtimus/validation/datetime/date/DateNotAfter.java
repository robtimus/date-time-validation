...
import com.github.robtimus.validation.datetime.date.DateNotAfter.List;
import com.github.robtimus.validation.datetime.date.validators.DateNotAfterValidator;
...
public @interface DateNotAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateNotAfter.message}";
