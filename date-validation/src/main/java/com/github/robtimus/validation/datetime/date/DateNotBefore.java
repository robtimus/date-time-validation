...
import com.github.robtimus.validation.datetime.date.DateNotBefore.List;
import com.github.robtimus.validation.datetime.date.validators.DateNotBeforeValidator;
...
public @interface DateNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.date.DateNotBefore.message}";
