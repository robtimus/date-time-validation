...
class DateNotAfterTest extends AbstractConstraintTest {
        ...
        class WithSystemZoneId extends ConstraintTest<Date> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "date",
                        Arrays.asList(
                                Date.from(utcInstantAtOffsetAfterSystem("2007-12-03T01:00:00.00Z", 1)),
                        ...
                        Date.from(utcInstantAtOffsetAfterSystem("2007-12-04T01:00:00.00Z", 1)),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<Calendar> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        Arrays.asList(
                                GregorianCalendar.from(zonedDateTimeAtDefaultZone("2007-12-03T00:00:00.00+01:00[Europe/Paris]")),
                        ...
                        GregorianCalendar.from(zonedDateTimeAtDefaultZone("2007-12-04T00:00:00.00+01:00[Europe/Paris]")),
        ...
        class WithMoment extends ConstraintTest<Calendar> {
            ...
            WithMoment() {
                super(TestClassWithProvidedZoneId.class, "calendar",
                        Arrays.asList(
                                GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T00:00:00.00+01:00[Europe/Paris]")),
                        ...
                        GregorianCalendar.from(ZonedDateTime.parse("2007-12-04T00:00:00.00+01:00[Europe/Paris]")),
                        () -> null);
            }
        }
        ...
        class WithZoneId extends ConstraintTest<Calendar> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "calendar",
                        Arrays.asList(
                                GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T01:00:00.00+01:00[Europe/Paris]")),
                        ...
                        GregorianCalendar.from(ZonedDateTime.parse("2007-12-04T01:00:00.00+01:00[Europe/Paris]")),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<Calendar> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "calendar",
                        Arrays.asList(
                                GregorianCalendar.from(zonedDateTimeAtOffsetAfterSystem("2007-12-03T01:00:00.00+01:00[Europe/Paris]", 1)),
                        ...
                        GregorianCalendar.from(zonedDateTimeAtOffsetAfterSystem("2007-12-04T01:00:00.00+01:00[Europe/Paris]", 1)),
                        () -> null);
            }
        }
    }
        ...
        class WithSystemZoneId extends ConstraintTest<Instant> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "instant",
                        Arrays.asList(
                                utcInstantAtOffsetAfterSystem("2007-12-03T01:00:00.00Z", 1),
                        ...
                        utcInstantAtOffsetAfterSystem("2007-12-04T01:00:00.00Z", 1),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<ZonedDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "zonedDateTime",
                        Arrays.asList(
                                zonedDateTimeAtDefaultZone("2007-12-03T00:00:00.00+01:00[Europe/Paris]"),
                        ...
                        zonedDateTimeAtDefaultZone("2007-12-04T00:00:00.00+01:00[Europe/Paris]"),
                        () -> Clock.fixed(ZonedDateTime.parse("2007-12-03T10:15:30+01:00[Europe/Paris]").toInstant(), ZoneId.of("Europe/Paris")));
            }
        }
        ...
        class WithMoment extends ConstraintTest<ZonedDateTime> {
            ...
            WithMoment() {
                super(TestClassWithProvidedZoneId.class, "zonedDateTime",
                        Arrays.asList(
                                ZonedDateTime.parse("2007-12-03T00:00:00.00+01:00[Europe/Paris]"),
                        ...
                        ZonedDateTime.parse("2007-12-04T00:00:00.00+01:00[Europe/Paris]"),
                        () -> null);
            }
        }
        ...
        class WithZoneId extends ConstraintTest<ZonedDateTime> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "zonedDateTime",
                        Arrays.asList(
                                ZonedDateTime.parse("2007-12-03T01:00:00.00+01:00[Europe/Paris]"),
                        ...
                        ZonedDateTime.parse("2007-12-04T01:00:00.00+01:00[Europe/Paris]"),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<ZonedDateTime> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "zonedDateTime",
                        Arrays.asList(
                                zonedDateTimeAtOffsetAfterSystem("2007-12-03T01:00:00.00+01:00[Europe/Paris]", 1),
                        ...
                        zonedDateTimeAtOffsetAfterSystem("2007-12-04T01:00:00.00+01:00[Europe/Paris]", 1),
                        () -> null);
            }
        }
    }
    ...
    private static final class TestClassWithNow {
        @DateNotAfter(moment = "now", zoneId = "system")
        Date date;
    ...
    private static final class TestClassWithProvidedZoneId {
        @DateNotAfter(moment = "2007-12-03", zoneId = "provided")
        Date date;
