...
import com.github.robtimus.validation.dayofmonth.LastDayOfMonth.List;
import com.github.robtimus.validation.dayofmonth.validators.LastDayOfMonthValidator;

/**
 * Validates that the day of the month of a date/time object is the last day of its month.
 * More specifically, for a date/time object {@code object}, validates that {@code object.dayOfMonth == object.month.lastDay}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { LastDayOfMonthValidator.ForDate.class,
        LastDayOfMonthValidator.ForCalendar.class,
        LastDayOfMonthValidator.ForInstant.class,
        LastDayOfMonthValidator.ForLocalDate.class,
        LastDayOfMonthValidator.ForLocalDateTime.class,
        LastDayOfMonthValidator.ForOffsetDateTime.class,
        LastDayOfMonthValidator.ForZonedDateTime.class
})
...
public @interface LastDayOfMonth {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.dayofmonth.LastDayOfMonth.message}";
    ...
    /**
     * Defines several {@link LastDayOfMonth} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link LastDayOfMonth} annotations.
         */
