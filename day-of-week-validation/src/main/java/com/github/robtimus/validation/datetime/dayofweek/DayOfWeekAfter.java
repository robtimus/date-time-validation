...
import com.github.robtimus.validation.datetime.dayofweek.DayOfWeekAfter.List;
import com.github.robtimus.validation.datetime.dayofweek.validators.DayOfWeekAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { DayOfWeekAfterValidator.ForDate.class,
        DayOfWeekAfterValidator.ForCalendar.class,
        DayOfWeekAfterValidator.ForDayOfWeek.class,
        DayOfWeekAfterValidator.ForInstant.class,
        DayOfWeekAfterValidator.ForLocalDate.class,
        DayOfWeekAfterValidator.ForLocalDateTime.class,
        DayOfWeekAfterValidator.ForOffsetDateTime.class,
        DayOfWeekAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface DayOfWeekAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.dayofweek.DayOfWeekAfter.message}";
    ...
    /**
     * The day of the week before the minimum allowed day of the week.
     */
    DayOfWeek value();
    ...
    /**
     * Defines several {@link DayOfWeekAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link DayOfWeekAfter} annotations.
         */
        DayOfWeekAfter[] value();
    }
}
