...
import com.github.robtimus.validation.datetime.dayofweek.DayOfWeekBefore.List;
import com.github.robtimus.validation.datetime.dayofweek.validators.DayOfWeekBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { DayOfWeekBeforeValidator.ForDate.class,
        DayOfWeekBeforeValidator.ForCalendar.class,
        DayOfWeekBeforeValidator.ForDayOfWeek.class,
        DayOfWeekBeforeValidator.ForInstant.class,
        DayOfWeekBeforeValidator.ForLocalDate.class,
        DayOfWeekBeforeValidator.ForLocalDateTime.class,
        DayOfWeekBeforeValidator.ForOffsetDateTime.class,
        DayOfWeekBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface DayOfWeekBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.dayofweek.DayOfWeekBefore.message}";
    ...
    /**
     * The day of the week after the maximum allowed day of the week.
     */
    DayOfWeek value();
    ...
    /**
     * Defines several {@link DayOfWeekBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link DayOfWeekBefore} annotations.
         */
        DayOfWeekBefore[] value();
    }
}
