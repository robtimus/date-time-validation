...
import com.github.robtimus.validation.datetime.dayofweek.DayOfWeekIn.List;
import com.github.robtimus.validation.datetime.dayofweek.validators.DayOfWeekInValidator;
...
public @interface DayOfWeekIn {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.dayofweek.DayOfWeekIn.message}";
