...
import com.github.robtimus.validation.datetime.dayofweek.DayOfWeekIs.List;
import com.github.robtimus.validation.datetime.dayofweek.validators.DayOfWeekIsValidator;
...
public @interface DayOfWeekIs {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.dayofweek.DayOfWeekIs.message}";
