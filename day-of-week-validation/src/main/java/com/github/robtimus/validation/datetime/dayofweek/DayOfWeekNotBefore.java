...
import com.github.robtimus.validation.datetime.dayofweek.DayOfWeekNotBefore.List;
import com.github.robtimus.validation.datetime.dayofweek.validators.DayOfWeekNotBeforeValidator;
...
public @interface DayOfWeekNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.dayofweek.DayOfWeekNotBefore.message}";
