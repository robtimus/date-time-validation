...
import com.github.robtimus.validation.dayofweek.DayOfWeekAfter.List;
import com.github.robtimus.validation.dayofweek.validators.DayOfWeekAfterValidator;
...
public @interface DayOfWeekAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.dayofweek.DayOfWeekAfter.message}";
