...
import com.github.robtimus.validation.dayofweek.DayOfWeekBefore.List;
import com.github.robtimus.validation.dayofweek.validators.DayOfWeekBeforeValidator;
...
public @interface DayOfWeekBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.dayofweek.DayOfWeekBefore.message}";
