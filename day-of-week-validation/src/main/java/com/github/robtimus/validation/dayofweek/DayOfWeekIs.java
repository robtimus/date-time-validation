...
import com.github.robtimus.validation.dayofweek.DayOfWeekIs.List;
import com.github.robtimus.validation.dayofweek.validators.DayOfWeekIsValidator;
...
public @interface DayOfWeekIs {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.dayofweek.DayOfWeekIs.message}";
