...
import com.github.robtimus.validation.dayofweek.DayOfWeekAfter;
    ...
    public static class ForDayOfWeek extends PartValidator.WithoutZoneId<DayOfWeekAfter, DayOfWeek, DayOfWeek> {
        ...
        public ForDayOfWeek() {
            ...
            useReplacementMessageTemplate(DayOfWeekAfter::message,
                    "{com.github.robtimus.validation.dayofweek.DayOfWeekAfter.message}",
                    "{com.github.robtimus.validation.dayofweek.DayOfWeekAfter.message.forDayOfWeek}");
        }
    }
