...
import com.github.robtimus.validation.hour.HourIs.List;
import com.github.robtimus.validation.hour.validators.HourIsValidator;

/**
 * Validates that the hour of a date/time object is a given value.
 * More specifically, for a date/time object {@code object}, validates that {@code object.hour == value}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { HourIsValidator.ForDate.class,
        HourIsValidator.ForCalendar.class,
        HourIsValidator.ForInstant.class,
        HourIsValidator.ForLocalDateTime.class,
        HourIsValidator.ForLocalTime.class,
        HourIsValidator.ForOffsetDateTime.class,
        HourIsValidator.ForOffsetTime.class,
        HourIsValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface HourIs {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.hour.HourIs.message}";
    ...
    /**
     * Defines several {@link HourIs} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
