...
import com.github.robtimus.validation.hour.HourNotIn.List;
import com.github.robtimus.validation.hour.validators.HourNotInValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { HourNotInValidator.ForDate.class,
        HourNotInValidator.ForCalendar.class,
        HourNotInValidator.ForInstant.class,
        HourNotInValidator.ForLocalDateTime.class,
        HourNotInValidator.ForLocalTime.class,
        HourNotInValidator.ForOffsetDateTime.class,
        HourNotInValidator.ForOffsetTime.class,
        HourNotInValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface HourNotIn {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.hour.HourNotIn.message}";
    ...
    /**
     * Defines several {@link HourNotIn} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link HourNotIn} annotations.
         */
        HourNotIn[] value();
    }
}
