...
import com.github.robtimus.validation.minute.MinuteIs.List;
import com.github.robtimus.validation.minute.validators.MinuteIsValidator;

/**
 * Validates that the minute of a date/time object is a given value.
 * More specifically, for a date/time object {@code object}, validates that {@code object.minute == value}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { MinuteIsValidator.ForDate.class,
        MinuteIsValidator.ForCalendar.class,
        MinuteIsValidator.ForInstant.class,
        MinuteIsValidator.ForLocalDateTime.class,
        MinuteIsValidator.ForLocalTime.class,
        MinuteIsValidator.ForOffsetDateTime.class,
        MinuteIsValidator.ForOffsetTime.class,
        MinuteIsValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface MinuteIs {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.minute.MinuteIs.message}";
    ...
    /**
     * Defines several {@link MinuteIs} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
