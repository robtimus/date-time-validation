...
import com.github.robtimus.validation.minute.MinuteModulo.List;
import com.github.robtimus.validation.minute.validators.MinuteModuloValidator;

/**
 * Validates that the minute of a date/time object modulo a given divider is equal to a given value.
 * More specifically, for a date/time object {@code object}, validates that {@code object.minute % modulo == minute % modulo}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { MinuteModuloValidator.ForDate.class,
        MinuteModuloValidator.ForCalendar.class,
        MinuteModuloValidator.ForInstant.class,
        MinuteModuloValidator.ForLocalDateTime.class,
        MinuteModuloValidator.ForLocalTime.class,
        MinuteModuloValidator.ForOffsetDateTime.class,
        MinuteModuloValidator.ForOffsetTime.class,
        MinuteModuloValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface MinuteModulo {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.minute.MinuteModulo.message}";
    ...
    /**
     * The required value after the modulo operation.
     */
    int minute();
    ...
    /**
     * Defines several {@link MinuteModulo} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link MinuteModulo} annotations.
         */
        MinuteModulo[] value();
    }
}
