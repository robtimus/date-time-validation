...
import com.github.robtimus.validation.datetime.month.MonthAfter.List;
import com.github.robtimus.validation.datetime.month.validators.MonthAfterValidator;
...
public @interface MonthAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthAfter.message}";
