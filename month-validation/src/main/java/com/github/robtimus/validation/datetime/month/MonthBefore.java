...
import com.github.robtimus.validation.datetime.month.MonthBefore.List;
import com.github.robtimus.validation.datetime.month.validators.MonthBeforeValidator;
...
public @interface MonthBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthBefore.message}";
