...
import com.github.robtimus.validation.datetime.month.MonthIn.List;
import com.github.robtimus.validation.datetime.month.validators.MonthInValidator;
...
public @interface MonthIn {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthIn.message}";
