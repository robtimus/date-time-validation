...
import com.github.robtimus.validation.datetime.month.MonthIs.List;
import com.github.robtimus.validation.datetime.month.validators.MonthIsValidator;
...
public @interface MonthIs {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthIs.message}";
