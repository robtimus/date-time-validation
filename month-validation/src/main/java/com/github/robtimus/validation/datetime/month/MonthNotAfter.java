...
import com.github.robtimus.validation.datetime.month.MonthNotAfter.List;
import com.github.robtimus.validation.datetime.month.validators.MonthNotAfterValidator;
...
public @interface MonthNotAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthNotAfter.message}";
