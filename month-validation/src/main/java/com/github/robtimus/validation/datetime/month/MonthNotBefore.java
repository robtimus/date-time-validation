...
import com.github.robtimus.validation.datetime.month.MonthNotBefore.List;
import com.github.robtimus.validation.datetime.month.validators.MonthNotBeforeValidator;
...
public @interface MonthNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.month.MonthNotBefore.message}";
