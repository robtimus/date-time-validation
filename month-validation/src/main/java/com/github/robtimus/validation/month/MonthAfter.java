...
import com.github.robtimus.validation.month.MonthAfter.List;
import com.github.robtimus.validation.month.validators.MonthAfterValidator;
...
public @interface MonthAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.month.MonthAfter.message}";
