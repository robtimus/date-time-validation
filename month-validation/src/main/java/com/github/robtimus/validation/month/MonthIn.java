...
import com.github.robtimus.validation.month.MonthIn.List;
import com.github.robtimus.validation.month.validators.MonthInValidator;
...
public @interface MonthIn {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.month.MonthIn.message}";
