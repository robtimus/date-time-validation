...
import com.github.robtimus.validation.month.MonthIs.List;
import com.github.robtimus.validation.month.validators.MonthIsValidator;
...
public @interface MonthIs {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.month.MonthIs.message}";
