...
import com.github.robtimus.validation.month.MonthNotAfter.List;
import com.github.robtimus.validation.month.validators.MonthNotAfterValidator;
...
public @interface MonthNotAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.month.MonthNotAfter.message}";
