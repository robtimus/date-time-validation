...
import com.github.robtimus.validation.month.MonthNotBefore.List;
import com.github.robtimus.validation.month.validators.MonthNotBeforeValidator;
...
public @interface MonthNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.month.MonthNotBefore.message}";
