...
import com.github.robtimus.validation.month.MonthAfter;
...
public final class MonthAfterValidator {
    ...
    public static class ForMonth extends PartValidator.WithoutZoneId<MonthAfter, Month, Month> {
        ...
        public ForMonth() {
            ...
            useReplacementMessageTemplate(MonthAfter::message,
                    "{com.github.robtimus.validation.month.MonthAfter.message}",
                    "{com.github.robtimus.validation.month.MonthAfter.message.forMonth}");
        }
    }
    ...
    private static Function<MonthAfter, BiPredicate<Month, ClockProvider>> predicate() {
        return annotation -> {
