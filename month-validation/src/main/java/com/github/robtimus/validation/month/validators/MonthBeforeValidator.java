...
import com.github.robtimus.validation.month.MonthBefore;
    ...
    public static class ForMonth extends PartValidator.WithoutZoneId<MonthBefore, Month, Month> {
        ...
        public ForMonth() {
            ...
            useReplacementMessageTemplate(MonthBefore::message,
                    "{com.github.robtimus.validation.month.MonthBefore.message}",
                    "{com.github.robtimus.validation.month.MonthBefore.message.forMonth}");
        }
    }
