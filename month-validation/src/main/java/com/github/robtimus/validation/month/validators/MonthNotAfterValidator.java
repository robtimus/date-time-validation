...
import com.github.robtimus.validation.month.MonthNotAfter;
    ...
    public static class ForMonth extends PartValidator.WithoutZoneId<MonthNotAfter, Month, Month> {
        ...
        public ForMonth() {
            ...
            useReplacementMessageTemplate(MonthNotAfter::message,
                    "{com.github.robtimus.validation.month.MonthNotAfter.message}",
                    "{com.github.robtimus.validation.month.MonthNotAfter.message.forMonth}");
        }
    }
