...
import com.github.robtimus.validation.time.After.List;
import com.github.robtimus.validation.time.validators.AfterValidator;
 ...
 * <p>
 * Note that {@code @After("now")} is equivalent to {@code @}{@link Future}.
 *
 * @author Rob Spoor
 */
@Documented
@Constraint(validatedBy = { AfterValidator.ForDate.class,
        AfterValidator.ForCalendar.class,
        AfterValidator.ForInstant.class,
        AfterValidator.ForLocalDate.class,
        AfterValidator.ForLocalDateTime.class,
        AfterValidator.ForLocalTime.class,
        AfterValidator.ForMonthDay.class,
        AfterValidator.ForOffsetDateTime.class,
        AfterValidator.ForOffsetTime.class,
        AfterValidator.ForYear.class,
        AfterValidator.ForYearMonth.class,
        AfterValidator.ForZonedDateTime.class
})
...
public @interface After {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.After.message}";
