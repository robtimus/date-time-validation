...
import com.github.robtimus.validation.time.MaxBefore.List;
 ...
 */
@Documented
@Constraint(validatedBy = { MaxBeforeValidator.ForDate.class,
        MaxBeforeValidator.ForCalendar.class,
        MaxBeforeValidator.ForInstant.class,
        MaxBeforeValidator.ForLocalDate.class,
        MaxBeforeValidator.ForLocalDateTime.class,
        MaxBeforeValidator.ForLocalTime.class,
        MaxBeforeValidator.ForOffsetDateTime.class,
        MaxBeforeValidator.ForOffsetTime.class,
        MaxBeforeValidator.ForYear.class,
        MaxBeforeValidator.ForYearMonth.class,
        MaxBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface MaxBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.MaxBefore.message}";
    ...
    /**
     * Defines several {@link MaxBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link MaxBefore} annotations.
         */
        MaxBefore[] value();
    }
}
