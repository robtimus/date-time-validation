...
import com.github.robtimus.validation.time.MinBefore.List;
 ...
 * More specifically, for a date/time object {@code value}, validates that {@code value &lt;= moment - duration}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { MinBeforeValidator.ForDate.class,
        MinBeforeValidator.ForCalendar.class,
        MinBeforeValidator.ForInstant.class,
        MinBeforeValidator.ForLocalDate.class,
        MinBeforeValidator.ForLocalDateTime.class,
        MinBeforeValidator.ForLocalTime.class,
        MinBeforeValidator.ForOffsetDateTime.class,
        MinBeforeValidator.ForOffsetTime.class,
        MinBeforeValidator.ForYear.class,
        MinBeforeValidator.ForYearMonth.class,
        MinBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface MinBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.MinBefore.message}";
    ...
    /**
     * Defines several {@link MinBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link MinBefore} annotations.
         */
        MinBefore[] value();
    }
}
