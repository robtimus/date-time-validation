...
import com.github.robtimus.validation.time.date.DateMaxBefore.List;
import com.github.robtimus.validation.time.date.validators.DateMaxBeforeValidator;
...
public @interface DateMaxBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DateMaxBefore.message}";
