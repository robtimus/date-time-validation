...
import com.github.robtimus.validation.time.date.DateMinAfter.List;
import com.github.robtimus.validation.time.date.validators.DateMinAfterValidator;
...
public @interface DateMinAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DateMinAfter.message}";
