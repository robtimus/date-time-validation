...
import com.github.robtimus.validation.time.date.DateMinBefore.List;
import com.github.robtimus.validation.time.date.validators.DateMinBeforeValidator;
...
public @interface DateMinBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DateMinBefore.message}";
