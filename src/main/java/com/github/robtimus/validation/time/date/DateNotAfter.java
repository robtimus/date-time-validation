...
import com.github.robtimus.validation.time.date.DateNotAfter.List;
import com.github.robtimus.validation.time.date.validators.DateNotAfterValidator;
...
public @interface DateNotAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DateNotAfter.message}";
