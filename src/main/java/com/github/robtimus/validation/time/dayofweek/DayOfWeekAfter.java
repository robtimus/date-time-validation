...
import com.github.robtimus.validation.time.dayofweek.DayOfWeekAfter.List;
import com.github.robtimus.validation.time.dayofweek.validators.DayOfWeekAfterValidator;
...
public @interface DayOfWeekAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DayOfWeekAfter.message}";
