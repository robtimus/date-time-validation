...
import com.github.robtimus.validation.time.dayofweek.DayOfWeekBefore.List;
import com.github.robtimus.validation.time.dayofweek.validators.DayOfWeekBeforeValidator;
...
public @interface DayOfWeekBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DayOfWeekBefore.message}";
