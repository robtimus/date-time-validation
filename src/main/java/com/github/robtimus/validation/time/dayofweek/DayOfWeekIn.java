...
import com.github.robtimus.validation.time.dayofweek.DayOfWeekIn.List;
import com.github.robtimus.validation.time.dayofweek.validators.DayOfWeekInValidator;
...
public @interface DayOfWeekIn {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.DayOfWeekIn.message}";
