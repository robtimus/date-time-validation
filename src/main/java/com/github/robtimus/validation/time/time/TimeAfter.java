...
import com.github.robtimus.validation.time.time.TimeAfter.List;
import com.github.robtimus.validation.time.time.validators.TimeAfterValidator;
...
public @interface TimeAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeAfter.message}";
