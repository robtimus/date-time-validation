...
import com.github.robtimus.validation.time.time.TimeMaxAfter.List;
import com.github.robtimus.validation.time.time.validators.TimeMaxAfterValidator;
...
public @interface TimeMaxAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeMaxAfter.message}";
