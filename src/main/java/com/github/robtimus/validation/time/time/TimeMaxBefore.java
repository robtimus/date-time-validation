...
import com.github.robtimus.validation.time.time.TimeMaxBefore.List;
import com.github.robtimus.validation.time.time.validators.TimeMaxBeforeValidator;
...
public @interface TimeMaxBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeMaxBefore.message}";
