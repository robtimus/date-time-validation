...
import com.github.robtimus.validation.time.time.TimeMinAfter.List;
import com.github.robtimus.validation.time.time.validators.TimeMinAfterValidator;
...
public @interface TimeMinAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeMinAfter.message}";
