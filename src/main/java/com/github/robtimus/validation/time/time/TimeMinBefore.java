...
import com.github.robtimus.validation.time.time.TimeMinBefore.List;
import com.github.robtimus.validation.time.time.validators.TimeMinBeforeValidator;
...
public @interface TimeMinBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeMinBefore.message}";
