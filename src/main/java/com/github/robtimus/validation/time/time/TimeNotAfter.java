...
import com.github.robtimus.validation.time.time.TimeNotAfter.List;
import com.github.robtimus.validation.time.time.validators.TimeNotAfterValidator;
...
public @interface TimeNotAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeNotAfter.message}";
