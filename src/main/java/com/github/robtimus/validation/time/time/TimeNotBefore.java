...
import com.github.robtimus.validation.time.time.TimeNotBefore.List;
import com.github.robtimus.validation.time.time.validators.TimeNotBeforeValidator;
...
public @interface TimeNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.time.TimeNotBefore.message}";
