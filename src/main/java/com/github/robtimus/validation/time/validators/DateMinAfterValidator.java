...
public final class DateMinAfterValidator {
    ...
    public static class ForDate extends AbstractDatePartValidator<DateMinAfter, LocalDate> {
         ...
         */
        public ForDate() {
            super(DateMinAfter::moment, DateMinAfter::duration, DateTimeValidator::toLocalDate, new MinAfterValidator.ForLocalDate());
        }
    }
    ...
    public static class ForCalendar extends AbstractCalendarPartValidator<DateMinAfter, LocalDate> {
         ...
         */
        public ForCalendar() {
            super(DateMinAfter::moment, DateMinAfter::duration, ZonedDateTime::toLocalDate, new MinAfterValidator.ForLocalDate());
        }
    }
    ...
    public static class ForLocalDateTime extends AbstractTemporalAccessorPartValidator<DateMinAfter, LocalDateTime, LocalDate> {
        ...
        public ForLocalDateTime() {
            super(DateMinAfter::moment, DateMinAfter::duration, LocalDateTime::toLocalDate, new MinAfterValidator.ForLocalDate());
        }
    }
    ...
    public static class ForOffsetDateTime extends AbstractTemporalAccessorPartValidator<DateMinAfter, OffsetDateTime, LocalDate> {
        ...
        public ForOffsetDateTime() {
            super(DateMinAfter::moment, DateMinAfter::duration, OffsetDateTime::toLocalDate, new MinAfterValidator.ForLocalDate());
        }
    }
