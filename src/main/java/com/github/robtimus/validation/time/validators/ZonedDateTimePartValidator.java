/*
 * ZonedDateTimePartValidator.java
...
/**
 * The base for all {@link ZonedDateTime} validators that validate only part of the value.
 *
 * @author Rob Spoor
 * @param <A> The constraint annotation type.
 * @param <P> The {@link TemporalAccessor} type that describes the part to validate.
 */
public abstract class ZonedDateTimePartValidator<A extends Annotation, P extends TemporalAccessor>
        extends TemporalAccessorPartValidator<A, ZonedDateTime, P> {
     ...
     */
    protected ZonedDateTimePartValidator(Function<A, String> momentExtractor,
            Function<A, String> zoneIdExtractor,
            Function<ZonedDateTime, P> partExtractor,
            TemporalAccessorValidator<?, P> partValidator) {

        super(momentExtractor, zoneIdExtractor, partExtractor, ZonedDateTime::withZoneSameInstant, partExtractor, partValidator);
    }
    ...
    protected ZonedDateTimePartValidator(Function<A, String> momentExtractor,
        ...
        super(momentExtractor, durationExtractor, zoneIdExtractor, partExtractor, ZonedDateTime::withZoneSameInstant, partExtractor, partValidator);
    }
}
