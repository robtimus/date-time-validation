...
class DateMaxAfterTest extends AbstractConstraintTest {
        ...
        class WithNow extends ConstraintTest<Date> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "date",
                        ...
                        Date.from(Instant.parse("2009-01-04T13:50:15.00Z").minus(24, ChronoUnit.HOURS)),
                        Date.from(Instant.parse("2009-01-04T13:50:15.00Z").plus(24, ChronoUnit.HOURS)),
        ...
        class WithZoneId extends ConstraintTest<Date> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "date",
                        ...
                        Date.from(utcInstantAtOffset("2009-01-05T00:50:15.00Z", 1).minus(24, ChronoUnit.HOURS)),
                        Date.from(utcInstantAtOffset("2009-01-05T00:50:15.00Z", 1).plus(24, ChronoUnit.HOURS)),
                        () -> null);
            }
        }
        ...
        class WithNow extends ConstraintTest<Calendar> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        ...
                        GregorianCalendar.from(ZonedDateTime.parse("2009-01-04T13:50:15+01:00[Europe/Paris]").minusDays(1)),
                        GregorianCalendar.from(ZonedDateTime.parse("2009-01-04T13:50:15+01:00[Europe/Paris]").plusDays(1)),
        ...
        class WithNow extends ConstraintTest<Instant> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "instant",
                        ...
                        Instant.parse("2009-01-04T13:50:15.00Z").minus(24, ChronoUnit.HOURS),
                        Instant.parse("2009-01-04T13:50:15.00Z").plus(24, ChronoUnit.HOURS),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        class WithZoneId extends ConstraintTest<Instant> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "instant",
                        ...
                        utcInstantAtOffset("2009-01-05T00:50:15.00Z", 1).minus(24, ChronoUnit.HOURS),
                        utcInstantAtOffset("2009-01-05T00:50:15.00Z", 1).plus(24, ChronoUnit.HOURS),
                        () -> null);
            }
        }
        ...
        class WithNow extends ConstraintTest<OffsetDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "offsetDateTime",
                        ...
                        OffsetDateTime.parse("2009-01-04T13:50:15+01:00").minusDays(1),
                        OffsetDateTime.parse("2009-01-04T13:50:15+01:00").plusDays(1),
        ...
        class WithZoneId extends ConstraintTest<OffsetDateTime> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "offsetDateTime",
                        ...
                        OffsetDateTime.parse("2009-01-05T00:50:15+01:00").minusDays(1),
                        OffsetDateTime.parse("2009-01-05T00:50:15+01:00").plusDays(1),
                        () -> null);
            }
        }
        ...
        class WithNow extends ConstraintTest<ZonedDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "zonedDateTime",
                        ...
                        ZonedDateTime.parse("2009-01-04T13:50:15+01:00[Europe/Paris]").minusDays(1),
                        ZonedDateTime.parse("2009-01-04T13:50:15+01:00[Europe/Paris]").plusDays(1),
                        () -> Clock.fixed(ZonedDateTime.parse("2007-12-03T10:15:30+01:00[Europe/Paris]").toInstant(), ZoneId.of("Europe/Paris")));
            }
        }
    ...
    private static final class TestClassWithNow {
        @DateMaxAfter(duration = "P1Y1M1D", moment = "now", zoneId = "provided")
        Date date;
