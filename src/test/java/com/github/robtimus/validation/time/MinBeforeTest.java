...
import com.github.robtimus.validation.time.validators.MinBeforeValidator;

@SuppressWarnings("nls")
class MinBeforeTest extends AbstractConstraintTest {
            ...
            class WithPeriodAndDuration extends ConstraintTest<Date> {
                ...
                WithPeriodAndDuration() {
                    super(TestClassWithNow.class, "date",
                            Date.from(Instant.parse("2006-11-02T09:14:29.00Z")),
                            Date.from(Instant.parse("2006-11-02T09:14:29.00Z").minusMillis(1)),
                            Date.from(Instant.parse("2006-11-02T09:14:29.00Z").plusMillis(1)),
            ...
            class WithDuration extends ConstraintTest<Date> {
                ...
                WithDuration() {
                    super(TestClassWithNow.class, "dateWithoutPeriod",
                            Date.from(Instant.parse("2007-12-03T09:14:29.00Z")),
                            Date.from(Instant.parse("2007-12-03T09:14:29.00Z").minusMillis(1)),
                            Date.from(Instant.parse("2007-12-03T09:14:29.00Z").plusMillis(1)),
                            () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
                }
            }
        }
        ...
        class WithNow extends ConstraintTest<Calendar> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        GregorianCalendar.from(ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]")),
                        GregorianCalendar.from(ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]").minus(1, ChronoUnit.MILLIS)),
                        GregorianCalendar.from(ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]").plus(1, ChronoUnit.MILLIS)),
            ...
            class WithPeriodAndDuration extends ConstraintTest<Instant> {
                ...
                WithPeriodAndDuration() {
                    super(TestClassWithNow.class, "instant",
                            Instant.parse("2006-11-02T09:14:29.00Z"),
                            Instant.parse("2006-11-02T09:14:29.00Z").minusNanos(1),
                            Instant.parse("2006-11-02T09:14:29.00Z").plusNanos(1),
                            () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
                }
            }
            ...
            class WithDuration extends ConstraintTest<Instant> {
                ...
                WithDuration() {
                    super(TestClassWithNow.class, "instantWithoutPeriod",
                            Instant.parse("2007-12-03T09:14:29.00Z"),
                            Instant.parse("2007-12-03T09:14:29.00Z").minusMillis(1),
                            Instant.parse("2007-12-03T09:14:29.00Z").plusMillis(1),
                            () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
                }
            }
        }
    ...
    class ForLocalDate {
        ...
        class WithNow extends ConstraintTest<LocalDate> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "localDate",
                        LocalDate.parse("2006-11-02"),
                        LocalDate.parse("2006-11-02").minusDays(1),
                        LocalDate.parse("2006-11-02").plusDays(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        void testInvalidDuration(String duration) {
            MinBefore constraintAnnotation = mock(MinBefore.class);
            when(constraintAnnotation.moment()).thenReturn("now");
            when(constraintAnnotation.duration()).thenReturn(duration);

            MinBeforeValidator.ForLocalDate validator = new MinBeforeValidator.ForLocalDate();
        ...
        class WithNow extends ConstraintTest<LocalDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "localDateTime",
                        LocalDateTime.parse("2006-11-02T09:14:29"),
                        LocalDateTime.parse("2006-11-02T09:14:29").minusNanos(1),
                        LocalDateTime.parse("2006-11-02T09:14:29").plusNanos(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
    ...
    class ForLocalTime {
        ...
        class WithNow extends ConstraintTest<LocalTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "localTime",
                        LocalTime.parse("09:14:29"),
                        LocalTime.parse("09:14:29").minusNanos(1),
                        LocalTime.parse("09:14:29").plusNanos(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        void testInvalidDuration(String duration) {
            ...
            MinBeforeValidator.ForLocalTime validator = new MinBeforeValidator.ForLocalTime();
            assertThrows(DateTimeException.class, () -> validator.initialize(constraintAnnotation));
        }
    }
    ...
    class ForOffsetDateTime {
        ...
        class WithNow extends ConstraintTest<OffsetDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "offsetDateTime",
                        OffsetDateTime.parse("2006-11-02T09:14:29+01:00"),
                        OffsetDateTime.parse("2006-11-02T09:14:29+01:00").minusNanos(1),
                        OffsetDateTime.parse("2006-11-02T09:14:29+01:00").plusNanos(1),
        ...
        class WithDifferentOffset extends ConstraintTest<OffsetDateTime> {
            ...
            WithDifferentOffset() {
                super(TestClassWithMoment.class, "offsetDateTime",
                        OffsetDateTime.parse("2006-11-02T07:14:29-01:00"),
                        OffsetDateTime.parse("2006-11-02T07:14:29-01:00").minusNanos(1),
                        OffsetDateTime.parse("2006-11-02T07:14:29-01:00").plusNanos(1),
                        () -> null);
            }
        }
    }
    ...
    class ForOffsetTime {
        ...
        class WithNow extends ConstraintTest<OffsetTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "offsetTime",
                        OffsetTime.parse("09:14:29+01:00"),
                        OffsetTime.parse("09:14:29+01:00").minusNanos(1),
                        OffsetTime.parse("09:14:29+01:00").plusNanos(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T09:15:30.00Z"), ZoneOffset.ofHours(1)));
            }
        }
        ...
        class WithDifferentOffset extends ConstraintTest<OffsetTime> {
            ...
            WithDifferentOffset() {
                super(TestClassWithMoment.class, "offsetTime",
                        OffsetTime.parse("07:14:29-01:00"),
                        OffsetTime.parse("07:14:29-01:00").minusNanos(1),
                        OffsetTime.parse("07:14:29-01:00").plusNanos(1),
                        () -> null);
            }
        }
        ...
        void testInvalidDuration(String duration) {
            ...
            MinBeforeValidator.ForOffsetTime validator = new MinBeforeValidator.ForOffsetTime();
            assertThrows(DateTimeException.class, () -> validator.initialize(constraintAnnotation));
        }
    }
    ...
    class ForYear {
        ...
        class WithNow extends ConstraintTest<Year> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "year",
                        Year.parse("2006"),
                        Year.parse("2006").minusYears(1),
                        Year.parse("2006").plusYears(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        void testInvalidDuration(String duration) {
            ...
            MinBeforeValidator.ForYear validator = new MinBeforeValidator.ForYear();
            assertThrows(DateTimeException.class, () -> validator.initialize(constraintAnnotation));
        }
    }
    ...
    class ForYearMonth {
        ...
        class WithNow extends ConstraintTest<YearMonth> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "yearMonth",
                        YearMonth.parse("2006-11"),
                        YearMonth.parse("2006-11").minusMonths(1),
                        YearMonth.parse("2006-11").plusMonths(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        void testInvalidDuration(String duration) {
            ...
            MinBeforeValidator.ForYearMonth validator = new MinBeforeValidator.ForYearMonth();
            assertThrows(DateTimeException.class, () -> validator.initialize(constraintAnnotation));
        }
    }
        ...
        class WithNow extends ConstraintTest<ZonedDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "zonedDateTime",
                        ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]"),
                        ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]").minusNanos(1),
                        ZonedDateTime.parse("2006-11-02T09:14:29+01:00[Europe/Paris]").plusNanos(1),
                        () -> Clock.fixed(ZonedDateTime.parse("2007-12-03T10:15:30+01:00[Europe/Paris]").toInstant(), ZoneId.of("Europe/Paris")));
            }
        }
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        private ConstraintTest(Class<?> beanType, String propertyName, T exactValue, T smallerValue, T largerValue, ClockProvider clockProvider) {
            ...
            MinBefore minBefore = assertDoesNotThrow(() -> beanType.getDeclaredField(propertyName))
                    .getAnnotation(MinBefore.class);
    ...
    private static final class TestClassWithNow {
        @MinBefore(duration = "P1Y1M1DT1H1M1S", moment = "now")
        Date date;

        @MinBefore(duration = "PT1H1M1S", moment = "now")
        ...
        @MinBefore(duration = "P1Y1M1D", moment = "now")
        LocalDate localDate;
        ...
        @MinBefore(duration = "P1Y", moment = "now")
        Year year;

        @MinBefore(duration = "P1Y1M", moment = "now")
        YearMonth yearMonth;
    ...
    private static final class TestClassWithMoment {
        @MinBefore(duration = "P1Y1M1DT1H1M1S", moment = "2007-12-03T10:15:30.00Z")
        Date date;

        @MinBefore(duration = "PT1H1M1S", moment = "2007-12-03T10:15:30.00Z")
        Date dateWithoutPeriod;

        @MinBefore(duration = "P1Y1M1DT1H1M1S", moment = "2007-12-03T10:15:30+01:00[Europe/Paris]")
        Calendar calendar;
        ...
        @MinBefore(duration = "P1Y1M1D", moment = "2007-12-03")
        LocalDate localDate;

        @MinBefore(duration = "P1Y1M1DT1H1M1S", moment = "2007-12-03T10:15:30")
        LocalDateTime localDateTime;

        @MinBefore(duration = "PT1H1M1S", moment = "10:15:30")
        LocalTime localTime;

        @MinBefore(duration = "P1Y1M1DT1H1M1S", moment = "2007-12-03T10:15:30+01:00")
        OffsetDateTime offsetDateTime;

        @MinBefore(duration = "PT1H1M1S", moment = "10:15:30+01:00")
        OffsetTime offsetTime;

        @MinBefore(duration = "P1Y", moment = "2007")
        Year year;

        @MinBefore(duration = "P1Y1M", moment = "2007-12")
        YearMonth yearMonth;
