...
class TimeAfterTest extends AbstractConstraintTest {
    ...
    private static final class TestClassWithNow {
        @TimeAfter(moment = "now", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithMoment {
        @TimeAfter(moment = "10:15:30", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithZoneId {
        @TimeAfter(moment = "10:15:30", zoneId = "UTC")
        Date date;
    ...
    private static final class TestClassWithSystemZoneId {
        @TimeAfter(moment = "10:15:30", zoneId = "system")
        Date date;
