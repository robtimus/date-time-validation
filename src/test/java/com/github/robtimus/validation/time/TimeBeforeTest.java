...
class TimeBeforeTest extends AbstractConstraintTest {
        ...
        class WithNow extends ConstraintTest<Calendar> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        GregorianCalendar.from(ZonedDateTime.parse("2021-10-24T11:15:30+02:00[Europe/Paris]")),
                        GregorianCalendar.from(ZonedDateTime.parse("2021-10-24T11:15:30+02:00[Europe/Paris]").minus(1, ChronoUnit.MILLIS)),
                        GregorianCalendar.from(ZonedDateTime.parse("2021-10-24T11:15:30+02:00[Europe/Paris]").plus(1, ChronoUnit.MILLIS)),
    ...
    private static final class TestClassWithNow {
        @TimeBefore(moment = "now", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithMoment {
        @TimeBefore(moment = "10:15:30", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithZoneId {
        @TimeBefore(moment = "10:15:30", zoneId = "UTC")
        Date date;
