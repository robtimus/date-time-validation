...
class TimeMaxAfterTest extends AbstractConstraintTest {
        ...
        class WithNow extends ConstraintTest<Date> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "date",
                        Date.from(utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z")),
                        Date.from(utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z").minusMillis(1)),
                        Date.from(utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z").plusMillis(1)),
        ...
        class WithNow extends ConstraintTest<Instant> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "instant",
                        utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z"),
                        utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z").minusMillis(1),
                        utcInstantAtDefaultZone("2021-10-24T11:16:31.00Z").plusMillis(1),
                        () -> Clock.fixed(Instant.parse("2007-12-03T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        private ConstraintTest(Class<?> beanType, String propertyName, T exactValue, T smallerValue, T largerValue, ClockProvider clockProvider) {
            ...
            TimeMaxAfter timeMaxAfter = assertDoesNotThrow(() -> beanType.getDeclaredField(propertyName))
                    .getAnnotation(TimeMaxAfter.class);
            this.moment = timeMaxAfter.moment();
            this.duration = timeMaxAfter.duration();
        }
    ...
    private static final class TestClassWithNow {
        @TimeMaxAfter(duration = "PT1H1M1S", moment = "now", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithMoment {
        @TimeMaxAfter(duration = "PT1H1M1S", moment = "10:15:30", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithSystemZoneId {
        @TimeMaxAfter(duration = "PT1H1M1S", moment = "10:15:30", zoneId = "system")
        Date date;
