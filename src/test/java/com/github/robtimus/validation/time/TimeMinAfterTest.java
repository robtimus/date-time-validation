...
class TimeMinAfterTest extends AbstractConstraintTest {
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        private ConstraintTest(Class<?> beanType, String propertyName, T exactValue, T smallerValue, T largerValue, ClockProvider clockProvider) {
            ...
            TimeMinAfter timeMinAfter = assertDoesNotThrow(() -> beanType.getDeclaredField(propertyName))
                    .getAnnotation(TimeMinAfter.class);
            this.moment = timeMinAfter.moment();
            this.duration = timeMinAfter.duration();
        }
    ...
    private static final class TestClassWithNow {
        @TimeMinAfter(duration = "PT1H1M1S", moment = "now", zoneId = "system")
        Date date;
