...
class SecondPrecisionTest extends AbstractConstraintTest {

    @Nested
    @DisplayName("Date")
    class ForDate extends ConstraintTest<Date> {

        ForDate() {
            super("date",
                    Arrays.asList(
                            Date.from(Instant.parse("2007-12-03T10:45:00Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:01Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:59Z"))
                    ),
                    Arrays.asList(
                            Date.from(Instant.parse("2007-12-03T10:45:00.001Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:00.999Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:01.001Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:01.999Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:59.001Z")),
                            Date.from(Instant.parse("2007-12-03T10:45:59.999Z"))
                    ));
        }
    }
    ...
    class ForCalendar extends ConstraintTest<Calendar> {

        ForCalendar() {
            super("calendar",
                    Arrays.asList(
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:00+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:01+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:59+01:00"))
                    ),
                    Arrays.asList(
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:00.001+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:00.999+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:01.001+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:01.999+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:59.001+01:00")),
                            GregorianCalendar.from(ZonedDateTime.parse("2007-12-03T10:45:59.999+01:00"))
                    ));
        }
    }
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        private ConstraintTest(String propertyName, List<T> allowedValues, List<T> notAllowedValues) {
            ...
            this.expectedMessage = "must have a minimum precision of seconds";
        }
        ...
        void testNotAllowedValue(T notAllowedValue) {
            ...
            assertAnnotation(violation, SecondPrecision.class);
