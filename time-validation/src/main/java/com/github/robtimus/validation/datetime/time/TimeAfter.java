...
import com.github.robtimus.validation.datetime.time.TimeAfter.List;
import com.github.robtimus.validation.datetime.time.validators.TimeAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { TimeAfterValidator.ForDate.class,
        TimeAfterValidator.ForCalendar.class,
        TimeAfterValidator.ForInstant.class,
        TimeAfterValidator.ForLocalDateTime.class,
        TimeAfterValidator.ForOffsetDateTime.class,
        TimeAfterValidator.ForZonedDateTime.class
})
...
public @interface TimeAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeAfter.message}";
    ...
    /**
     * Defines several {@link TimeAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link TimeAfter} annotations.
         */
        TimeAfter[] value();
    }
}
