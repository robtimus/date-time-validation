...
import com.github.robtimus.validation.datetime.time.TimeBefore.List;
import com.github.robtimus.validation.datetime.time.validators.TimeBeforeValidator;
...
public @interface TimeBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeBefore.message}";
