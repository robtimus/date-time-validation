...
import com.github.robtimus.validation.datetime.time.TimeMaxAfter.List;
import com.github.robtimus.validation.datetime.time.validators.TimeMaxAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { TimeMaxAfterValidator.ForDate.class,
        TimeMaxAfterValidator.ForCalendar.class,
        TimeMaxAfterValidator.ForInstant.class,
        TimeMaxAfterValidator.ForLocalDateTime.class,
        TimeMaxAfterValidator.ForOffsetDateTime.class,
        TimeMaxAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface TimeMaxAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeMaxAfter.message}";
    ...
    /**
     * Defines several {@link TimeMaxAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link TimeMaxAfter} annotations.
         */
        TimeMaxAfter[] value();
    }
}
