...
import com.github.robtimus.validation.datetime.time.TimeMaxBefore.List;
import com.github.robtimus.validation.datetime.time.validators.TimeMaxBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { TimeMaxBeforeValidator.ForDate.class,
        TimeMaxBeforeValidator.ForCalendar.class,
        TimeMaxBeforeValidator.ForInstant.class,
        TimeMaxBeforeValidator.ForLocalDateTime.class,
        TimeMaxBeforeValidator.ForOffsetDateTime.class,
        TimeMaxBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface TimeMaxBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeMaxBefore.message}";
    ...
    /**
     * The maximum amount of time, as an <a href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 duration</a>, that the time part of
     * a date/time object can be before the value specified in {@link #moment()}.
     * <p>
     * This duration may only have a time part, not a date part.
     */
    String duration();
    ...
    /**
     * Defines several {@link TimeMaxBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link TimeMaxBefore} annotations.
         */
        TimeMaxBefore[] value();
    }
}
