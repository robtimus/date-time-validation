...
import com.github.robtimus.validation.datetime.time.TimeMinAfter.List;
import com.github.robtimus.validation.datetime.time.validators.TimeMinAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { TimeMinAfterValidator.ForDate.class,
        TimeMinAfterValidator.ForCalendar.class,
        TimeMinAfterValidator.ForInstant.class,
        TimeMinAfterValidator.ForLocalDateTime.class,
        TimeMinAfterValidator.ForOffsetDateTime.class,
        TimeMinAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface TimeMinAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeMinAfter.message}";
    ...
    /**
     * The minimum amount of time, as an <a href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 duration</a>, that the time part of
    ...
    /**
     * Defines several {@link TimeMinAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link TimeMinAfter} annotations.
         */
        TimeMinAfter[] value();
    }
}
