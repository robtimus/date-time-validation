...
import com.github.robtimus.validation.datetime.time.TimeMinBefore.List;
import com.github.robtimus.validation.datetime.time.validators.TimeMinBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { TimeMinBeforeValidator.ForDate.class,
        TimeMinBeforeValidator.ForCalendar.class,
        TimeMinBeforeValidator.ForInstant.class,
        TimeMinBeforeValidator.ForLocalDateTime.class,
        TimeMinBeforeValidator.ForOffsetDateTime.class,
        TimeMinBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface TimeMinBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeMinBefore.message}";
    ...
    public @interface List {
        ...
        /**
         * The {@link TimeMinBefore} annotations.
         */
        TimeMinBefore[] value();
    }
}
