...
import com.github.robtimus.validation.datetime.time.TimeNotAfter.List;
import com.github.robtimus.validation.datetime.time.validators.TimeNotAfterValidator;
...
public @interface TimeNotAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.time.TimeNotAfter.message}";
    ...
    public @interface List {
        ...
        /**
         * The {@link TimeNotAfter} annotations.
         */
        TimeNotAfter[] value();
    }
}
