...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthAfter.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMonthAfterValidator.ForDate.class,
        YearMonthAfterValidator.ForCalendar.class,
        YearMonthAfterValidator.ForInstant.class,
        YearMonthAfterValidator.ForLocalDate.class,
        YearMonthAfterValidator.ForLocalDateTime.class,
        YearMonthAfterValidator.ForOffsetDateTime.class,
        YearMonthAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMonthAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthAfter.message}";
    ...
    /**
     * Defines several {@link YearMonthAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthAfter} annotations.
         */
        YearMonthAfter[] value();
    }
}
