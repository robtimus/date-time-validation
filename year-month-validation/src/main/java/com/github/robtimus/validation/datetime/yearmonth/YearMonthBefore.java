...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthBefore.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMonthBeforeValidator.ForDate.class,
        YearMonthBeforeValidator.ForCalendar.class,
        YearMonthBeforeValidator.ForInstant.class,
        YearMonthBeforeValidator.ForLocalDate.class,
        YearMonthBeforeValidator.ForLocalDateTime.class,
        YearMonthBeforeValidator.ForOffsetDateTime.class,
        YearMonthBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMonthBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthBefore.message}";
    ...
    /**
     * Defines several {@link YearMonthBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthBefore} annotations.
         */
        YearMonthBefore[] value();
    }
}
