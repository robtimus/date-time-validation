...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthMaxAfter.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthMaxAfterValidator;
...
public @interface YearMonthMaxAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthMaxAfter.message}";
