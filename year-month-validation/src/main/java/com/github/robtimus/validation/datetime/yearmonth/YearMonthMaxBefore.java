...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthMaxBefore.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthMaxBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMonthMaxBeforeValidator.ForDate.class,
        YearMonthMaxBeforeValidator.ForCalendar.class,
        YearMonthMaxBeforeValidator.ForInstant.class,
        YearMonthMaxBeforeValidator.ForLocalDate.class,
        YearMonthMaxBeforeValidator.ForLocalDateTime.class,
        YearMonthMaxBeforeValidator.ForOffsetDateTime.class,
        YearMonthMaxBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMonthMaxBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthMaxBefore.message}";
    ...
    /**
     * Defines several {@link YearMonthMaxBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthMaxBefore} annotations.
         */
        YearMonthMaxBefore[] value();
    }
}
