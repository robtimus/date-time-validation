...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthMinAfter.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthMinAfterValidator;
...
public @interface YearMonthMinAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthMinAfter.message}";
