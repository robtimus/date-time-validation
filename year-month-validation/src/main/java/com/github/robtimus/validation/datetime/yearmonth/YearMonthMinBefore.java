...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthMinBefore.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthMinBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMonthMinBeforeValidator.ForDate.class,
        YearMonthMinBeforeValidator.ForCalendar.class,
        YearMonthMinBeforeValidator.ForInstant.class,
        YearMonthMinBeforeValidator.ForLocalDate.class,
        YearMonthMinBeforeValidator.ForLocalDateTime.class,
        YearMonthMinBeforeValidator.ForOffsetDateTime.class,
        YearMonthMinBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMonthMinBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthMinBefore.message}";
    ...
    /**
     * Defines several {@link YearMonthMinBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthMinBefore} annotations.
         */
        YearMonthMinBefore[] value();
    }
}
