...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthNotAfter.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthNotAfterValidator;
...
public @interface YearMonthNotAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthNotAfter.message}";
    ...
    /**
     * Defines several {@link YearMonthNotAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthNotAfter} annotations.
         */
        YearMonthNotAfter[] value();
    }
}
