...
import com.github.robtimus.validation.datetime.yearmonth.YearMonthNotBefore.List;
import com.github.robtimus.validation.datetime.yearmonth.validators.YearMonthNotBeforeValidator;

/**
 * Validates that the year-month part of a date/time object is not before a specific moment in time.
 * More specifically, for a date/time object {@code value}, validates that {@code value.yearmonth &gt;= moment}.
 * <p>
 * Supported types are:
 * <ul>
 ...
 */
@Documented
@Constraint(validatedBy = { YearMonthNotBeforeValidator.ForDate.class,
        YearMonthNotBeforeValidator.ForCalendar.class,
        YearMonthNotBeforeValidator.ForInstant.class,
        YearMonthNotBeforeValidator.ForLocalDate.class,
        YearMonthNotBeforeValidator.ForLocalDateTime.class,
        YearMonthNotBeforeValidator.ForOffsetDateTime.class,
        YearMonthNotBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMonthNotBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.datetime.yearmonth.YearMonthNotBefore.message}";
    ...
    /**
     * Defines several {@link YearMonthNotBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMonthNotBefore} annotations.
         */
        YearMonthNotBefore[] value();
    }
}
