...
import com.github.robtimus.validation.yearmonth.YearMonthAfter.List;
import com.github.robtimus.validation.yearmonth.validators.YearMonthAfterValidator;
...
public @interface YearMonthAfter {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.yearmonth.YearMonthAfter.message}";
