...
import com.github.robtimus.validation.yearmonth.YearMonthBefore.List;
import com.github.robtimus.validation.yearmonth.validators.YearMonthBeforeValidator;
...
public @interface YearMonthBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.yearmonth.YearMonthBefore.message}";
