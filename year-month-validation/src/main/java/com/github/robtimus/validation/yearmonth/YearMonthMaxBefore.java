...
import com.github.robtimus.validation.yearmonth.YearMonthMaxBefore.List;
import com.github.robtimus.validation.yearmonth.validators.YearMonthMaxBeforeValidator;
...
public @interface YearMonthMaxBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.yearmonth.YearMonthMaxBefore.message}";
