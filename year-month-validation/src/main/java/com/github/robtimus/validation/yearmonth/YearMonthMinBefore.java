...
import com.github.robtimus.validation.yearmonth.YearMonthMinBefore.List;
import com.github.robtimus.validation.yearmonth.validators.YearMonthMinBeforeValidator;
...
public @interface YearMonthMinBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.yearmonth.YearMonthMinBefore.message}";
