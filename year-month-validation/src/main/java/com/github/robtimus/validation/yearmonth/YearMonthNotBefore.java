...
import com.github.robtimus.validation.yearmonth.YearMonthNotBefore.List;
import com.github.robtimus.validation.yearmonth.validators.YearMonthNotBeforeValidator;

/**
 * Validates that the year-month part of a date/time object is not before a specific moment in time.
 * More specifically, for a date/time object {@code object}, validates that {@code object.yearMonth >= moment}.
 * <p>
 * Supported types are:
 * <ul>
...
public @interface YearMonthNotBefore {
     ...
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.yearmonth.YearMonthNotBefore.message}";
