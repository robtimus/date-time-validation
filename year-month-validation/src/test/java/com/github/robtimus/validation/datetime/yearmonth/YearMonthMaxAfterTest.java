...
package com.github.robtimus.validation.datetime.yearmonth;
...
class YearMonthMaxAfterTest extends AbstractConstraintTest {
        ...
        class WithNow extends ConstraintTest<Date> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "date",
                        ...
                        Date.from(Instant.parse("2008-12-31T13:50:15.00Z")),
                        Date.from(Instant.parse("2009-02-01T13:50:15.00Z")),
        ...
        class WithZoneId extends ConstraintTest<Date> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "date",
                        Date.from(utcInstantAtOffset("2009-02-01T00:50:15.00Z", 1)),
                        Date.from(utcInstantAtOffset("2009-01-01T00:50:15.00Z", 1)),
                        Date.from(utcInstantAtOffset("2009-02-02T00:50:15.00Z", 1)),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<Date> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "date",
                        Date.from(utcInstantAtOffsetAfterSystem("2009-02-01T00:50:15.00Z", 1)),
                        Date.from(utcInstantAtOffsetAfterSystem("2009-01-01T00:50:15.00Z", 1)),
                        Date.from(utcInstantAtOffsetAfterSystem("2009-02-02T00:50:15.00Z", 1)),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<Calendar> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        ...
                        GregorianCalendar.from(ZonedDateTime.parse("2008-12-31T13:50:15+01:00[Europe/Paris]")),
                        GregorianCalendar.from(ZonedDateTime.parse("2009-02-01T13:50:15+01:00[Europe/Paris]")),
        ...
        class WithZoneId extends ConstraintTest<Calendar> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "calendar",
                        GregorianCalendar.from(ZonedDateTime.parse("2009-02-01T00:50:15+01:00[Europe/Paris]")),
                        GregorianCalendar.from(ZonedDateTime.parse("2009-01-01T00:50:15+01:00[Europe/Paris]")),
                        GregorianCalendar.from(ZonedDateTime.parse("2009-02-02T00:50:15+01:00[Europe/Paris]")),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<Calendar> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "calendar",
                        GregorianCalendar.from(zonedDateTimeAtOffsetAfterSystem("2009-02-01T00:50:15+01:00[Europe/Paris]", 1)),
                        GregorianCalendar.from(zonedDateTimeAtOffsetAfterSystem("2009-01-01T00:50:15+01:00[Europe/Paris]", 1)),
                        GregorianCalendar.from(zonedDateTimeAtOffsetAfterSystem("2009-02-02T00:50:15+01:00[Europe/Paris]", 1)),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<Instant> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "instant",
                        ...
                        Instant.parse("2008-12-31T13:50:15.00Z"),
                        Instant.parse("2009-02-01T13:50:15.00Z"),
                        () -> Clock.fixed(Instant.parse("2007-12-01T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        class WithZoneId extends ConstraintTest<Instant> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "instant",
                        utcInstantAtOffset("2009-02-01T00:50:15.00Z", 1),
                        utcInstantAtOffset("2009-01-01T00:50:15.00Z", 1),
                        utcInstantAtOffset("2009-02-02T00:50:15.00Z", 1),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<Instant> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "instant",
                        utcInstantAtOffsetAfterSystem("2009-02-01T00:50:15.00Z", 1),
                        utcInstantAtOffsetAfterSystem("2009-01-01T00:50:15.00Z", 1),
                        utcInstantAtOffsetAfterSystem("2009-02-02T00:50:15.00Z", 1),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<LocalDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "localDateTime",
                        ...
                        LocalDateTime.parse("2008-12-31T13:50:15"),
                        LocalDateTime.parse("2009-02-01T13:50:15"),
                        () -> Clock.fixed(Instant.parse("2007-12-01T10:15:30.00Z"), ZoneId.of("UTC")));
            }
        }
        ...
        class WithNow extends ConstraintTest<OffsetDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "offsetDateTime",
                        ...
                        OffsetDateTime.parse("2008-12-31T13:50:15+01:00"),
                        OffsetDateTime.parse("2009-02-01T13:50:15+01:00"),
        ...
        class WithZoneId extends ConstraintTest<OffsetDateTime> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "offsetDateTime",
                        OffsetDateTime.parse("2009-02-01T00:50:15+01:00"),
                        OffsetDateTime.parse("2009-01-01T00:50:15+01:00"),
                        OffsetDateTime.parse("2009-02-02T00:50:15+01:00"),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<OffsetDateTime> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "offsetDateTime",
                        offsetDateTimeAtOffsetAfterSystem("2009-02-01T00:50:15+01:00", 1),
                        offsetDateTimeAtOffsetAfterSystem("2009-01-01T00:50:15+01:00", 1),
                        offsetDateTimeAtOffsetAfterSystem("2009-02-02T00:50:15+01:00", 1),
                        () -> null);
            }
        }
    }
        ...
        class WithNow extends ConstraintTest<ZonedDateTime> {
            ...
            WithNow() {
                super(TestClassWithNow.class, "zonedDateTime",
                        ...
                        ZonedDateTime.parse("2008-12-31T13:50:15+01:00[Europe/Paris]"),
                        ZonedDateTime.parse("2009-02-01T13:50:15+01:00[Europe/Paris]"),
                        () -> Clock.fixed(ZonedDateTime.parse("2007-12-01T10:15:30+01:00[Europe/Paris]").toInstant(), ZoneId.of("Europe/Paris")));
            }
        }
        ...
        class WithZoneId extends ConstraintTest<ZonedDateTime> {
            ...
            WithZoneId() {
                super(TestClassWithZoneId.class, "zonedDateTime",
                        ZonedDateTime.parse("2009-02-01T00:50:15+01:00[Europe/Paris]"),
                        ZonedDateTime.parse("2009-01-01T00:50:15+01:00[Europe/Paris]"),
                        ZonedDateTime.parse("2009-02-02T00:50:15+01:00[Europe/Paris]"),
                        () -> null);
            }
        }
        ...
        class WithSystemZoneId extends ConstraintTest<ZonedDateTime> {
            ...
            WithSystemZoneId() {
                super(TestClassWithSystemZoneId.class, "zonedDateTime",
                        zonedDateTimeAtOffsetAfterSystem("2009-02-01T00:50:15+01:00[Europe/Paris]", 1),
                        zonedDateTimeAtOffsetAfterSystem("2009-01-01T00:50:15+01:00[Europe/Paris]", 1),
                        zonedDateTimeAtOffsetAfterSystem("2009-02-02T00:50:15+01:00[Europe/Paris]", 1),
                        () -> null);
            }
        }
    }
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        private ConstraintTest(Class<?> beanType, String propertyName, T exactValue, T smallerValue, T largerValue, ClockProvider clockProvider) {
            ...
            YearMonthMaxAfter maxAfter = assertDoesNotThrow(() -> beanType.getDeclaredField(propertyName))
                    .getAnnotation(YearMonthMaxAfter.class);
        ...
        void testLargerValue() {
            ...
            assertAnnotation(violation, YearMonthMaxAfter.class);
            assertEquals("must have a year-month that is at most " + duration + " after " + moment, violation.getMessage());
            assertEquals(propertyName, violation.getPropertyPath().toString());
        }
    }

    private static final class TestClassWithNow {
        @YearMonthMaxAfter(duration = "P1Y1M", moment = "now", zoneId = "system")
        Date date;
    ...
    private static final class TestClassWithProvidedZoneId {
        @YearMonthMaxAfter(duration = "P1Y1M", moment = "2007-12", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithZoneId {
        @YearMonthMaxAfter(duration = "P1Y1M", moment = "2007-12", zoneId = "UTC")
        Date date;
    ...
    private static final class TestClassWithSystemZoneId {
        @YearMonthMaxAfter(duration = "P1Y1M", moment = "2007-12")
        Date date;
