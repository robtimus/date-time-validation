...
import com.github.robtimus.validation.year.YearAfter.List;
import com.github.robtimus.validation.year.validators.YearAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearAfterValidator.ForDate.class,
        YearAfterValidator.ForCalendar.class,
        YearAfterValidator.ForInstant.class,
        YearAfterValidator.ForLocalDate.class,
        YearAfterValidator.ForLocalDateTime.class,
        YearAfterValidator.ForOffsetDateTime.class,
        YearAfterValidator.ForYearMonth.class,
        YearAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearAfter.message}";
    ...
    /**
     * Defines several {@link YearAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
