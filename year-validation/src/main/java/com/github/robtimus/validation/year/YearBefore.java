...
import com.github.robtimus.validation.year.YearBefore.List;
import com.github.robtimus.validation.year.validators.YearBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearBeforeValidator.ForDate.class,
        YearBeforeValidator.ForCalendar.class,
        YearBeforeValidator.ForInstant.class,
        YearBeforeValidator.ForLocalDate.class,
        YearBeforeValidator.ForLocalDateTime.class,
        YearBeforeValidator.ForOffsetDateTime.class,
        YearBeforeValidator.ForYearMonth.class,
        YearBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearBefore.message}";
    ...
    /**
     * Defines several {@link YearBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    @interface List {
        ...
        /**
         * The {@link YearBefore} annotations.
         */
        YearBefore[] value();
    }
}
