...
import com.github.robtimus.validation.year.YearMaxAfter.List;
import com.github.robtimus.validation.year.validators.YearMaxAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMaxAfterValidator.ForDate.class,
        YearMaxAfterValidator.ForCalendar.class,
        YearMaxAfterValidator.ForInstant.class,
        YearMaxAfterValidator.ForLocalDate.class,
        YearMaxAfterValidator.ForLocalDateTime.class,
        YearMaxAfterValidator.ForOffsetDateTime.class,
        YearMaxAfterValidator.ForYearMonth.class,
        YearMaxAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMaxAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearMaxAfter.message}";
    ...
    /**
     * The maximum number of years that the year part of a date/time object can be after the value specified in {@link #moment()}.
     */
    int years();
    ...
    /**
     * Defines several {@link YearMaxAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMaxAfter} annotations.
         */
        YearMaxAfter[] value();
    }
}
