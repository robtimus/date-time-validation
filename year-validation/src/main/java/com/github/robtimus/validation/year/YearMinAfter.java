...
import com.github.robtimus.validation.year.YearMinAfter.List;
import com.github.robtimus.validation.year.validators.YearMinAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMinAfterValidator.ForDate.class,
        YearMinAfterValidator.ForCalendar.class,
        YearMinAfterValidator.ForInstant.class,
        YearMinAfterValidator.ForLocalDate.class,
        YearMinAfterValidator.ForLocalDateTime.class,
        YearMinAfterValidator.ForOffsetDateTime.class,
        YearMinAfterValidator.ForYearMonth.class,
        YearMinAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMinAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearMinAfter.message}";
    ...
    /**
     * The minimum number of years that the year part of a date/time object can be after the value specified in {@link #moment()}.
     */
    int years();
    ...
    /**
     * Defines several {@link YearMinAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearMinAfter} annotations.
         */
        YearMinAfter[] value();
    }
}
