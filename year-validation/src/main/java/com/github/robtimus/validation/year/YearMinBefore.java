...
import com.github.robtimus.validation.year.YearMinBefore.List;
import com.github.robtimus.validation.year.validators.YearMinBeforeValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearMinBeforeValidator.ForDate.class,
        YearMinBeforeValidator.ForCalendar.class,
        YearMinBeforeValidator.ForInstant.class,
        YearMinBeforeValidator.ForLocalDate.class,
        YearMinBeforeValidator.ForLocalDateTime.class,
        YearMinBeforeValidator.ForOffsetDateTime.class,
        YearMinBeforeValidator.ForYearMonth.class,
        YearMinBeforeValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearMinBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearMinBefore.message}";
    ...
    /**
     * Defines several {@link YearMinBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    @interface List {
        ...
        /**
         * The {@link YearMinBefore} annotations.
         */
        YearMinBefore[] value();
    }
}
