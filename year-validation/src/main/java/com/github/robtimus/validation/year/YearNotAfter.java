...
import com.github.robtimus.validation.year.YearNotAfter.List;
import com.github.robtimus.validation.year.validators.YearNotAfterValidator;
 ...
 */
@Documented
@Constraint(validatedBy = { YearNotAfterValidator.ForDate.class,
        YearNotAfterValidator.ForCalendar.class,
        YearNotAfterValidator.ForInstant.class,
        YearNotAfterValidator.ForLocalDate.class,
        YearNotAfterValidator.ForLocalDateTime.class,
        YearNotAfterValidator.ForOffsetDateTime.class,
        YearNotAfterValidator.ForYearMonth.class,
        YearNotAfterValidator.ForZonedDateTime.class
})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(List.class)
public @interface YearNotAfter {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearNotAfter.message}";
    ...
    /**
     * Defines several {@link YearNotAfter} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearNotAfter} annotations.
         */
        YearNotAfter[] value();
    }
}
