...
public @interface YearNotBefore {

    /**
     * The error message.
     */
    String message() default "{com.github.robtimus.validation.year.YearNotBefore.message}";
    ...
    /**
     * Defines several {@link YearNotBefore} annotations on the same element.
     */
    @Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
    @Retention(RUNTIME)
    @Documented
    public @interface List {
        ...
        /**
         * The {@link YearNotBefore} annotations.
         */
        YearNotBefore[] value();
    }
}
