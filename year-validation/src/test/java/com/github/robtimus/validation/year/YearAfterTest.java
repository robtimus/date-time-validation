...
class YearAfterTest extends AbstractConstraintTest {
    ...
    private abstract static class ConstraintTest<T> extends AbstractConstraintTest {
        ...
        void testExactValue(T exactValue) {
            ...
            assertAnnotation(violation, YearAfter.class);
            assertEquals("must have a year that is after " + moment, violation.getMessage());
    ...
    private static final class TestClassWithNow {
        @YearAfter(moment = "now", zoneId = "system")
        Date date;
    ...
    private static final class TestClassWithProvidedZoneId {
        @YearAfter(moment = "2007", zoneId = "provided")
        Date date;
    ...
    private static final class TestClassWithZoneId {
        @YearAfter(moment = "2007", zoneId = "UTC")
        Date date;
