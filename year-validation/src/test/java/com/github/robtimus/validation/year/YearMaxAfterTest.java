...
class YearMaxAfterTest extends AbstractConstraintTest {
            ...
            WithNow() {
                super(TestClassWithNow.class, "date",
                        Arrays.asList(
                                ...
                                Date.from(utcInstantAtDefaultZone("2008-12-31T00:59:59.999Z"))
                        ),
                        Date.from(utcInstantAtDefaultZone("2007-12-31T23:59:59.999Z")),
            ...
            WithNow() {
                super(TestClassWithNow.class, "calendar",
                        Arrays.asList(
                                ...
                                GregorianCalendar.from(zonedDateTimeAtDefaultZone("2008-12-31T00:59:59.999+01:00[Europe/Paris]"))
                        ),
                        GregorianCalendar.from(zonedDateTimeAtDefaultZone("2007-12-31T23:59:59.999+01:00[Europe/Paris]")),
            ...
            WithMoment() {
                super(TestClassWithProvidedZoneId.class, "calendar",
                        Arrays.asList(
                                ...
                                GregorianCalendar.from(ZonedDateTime.parse("2008-12-31T00:59:59.999+01:00[Europe/Paris]"))
                        ),
                        GregorianCalendar.from(ZonedDateTime.parse("2007-12-31T23:59:59.999+01:00[Europe/Paris]")),
            ...
            WithNow() {
                super(TestClassWithNow.class, "instant",
                        Arrays.asList(
                                ...
                                utcInstantAtDefaultZone("2008-12-31T00:59:59.999999999Z")
                        ),
                        utcInstantAtDefaultZone("2007-12-31T23:59:59.999999999Z"),
            ...
            WithNow() {
                super(TestClassWithNow.class, "localDateTime",
                        Arrays.asList(
                                ...
                                LocalDateTime.parse("2008-12-31T00:59:59.999999999")
                        ),
            ...
            WithNow() {
                super(TestClassWithNow.class, "offsetDateTime",
                        Arrays.asList(
                                ...
                                offsetDateTimeAtDefaultZone("2008-12-31T00:59:59.999999999+01:00")
                        ),
                        offsetDateTimeAtDefaultZone("2007-12-31T23:59:59.999999999+01:00"),
            ...
            WithMoment() {
                super(TestClassWithProvidedZoneId.class, "offsetDateTime",
                        Arrays.asList(
                                ...
                                OffsetDateTime.parse("2008-12-31T00:59:59.999999999+01:00")
                        ),
            ...
            WithNow() {
                super(TestClassWithNow.class, "zonedDateTime",
                        Arrays.asList(
                                ...
                                zonedDateTimeAtDefaultZone("2008-12-31T00:59:59.999+01:00[Europe/Paris]")
                        ),
                        zonedDateTimeAtDefaultZone("2007-12-31T23:59:59.999+01:00[Europe/Paris]"),
            ...
            WithMoment() {
                super(TestClassWithProvidedZoneId.class, "zonedDateTime",
                        Arrays.asList(
                                ...
                                ZonedDateTime.parse("2008-12-31T00:59:59.999+01:00[Europe/Paris]")
                        ),
                        ZonedDateTime.parse("2007-12-31T23:59:59.999+01:00[Europe/Paris]"),
